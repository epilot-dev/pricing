...
declare namespace Components {
  namespace Schemas {
    ...
    export interface BasePriceItem {
       ...
       */
      readonly unit_amount_net?: number;
      /**
       ...
       */
      price_mappings?: PriceInputMappings;
      /**
    ...
    export interface CompositePriceItemDto {
       ...
       * Contains price item configurations, per price component, when the main price item is a [composite price](/api/pricing#tag/dynamic_price_schema).
       */
      item_components?: PriceItemDto[];
      _price?: CompositePrice;
      metadata?: MetaData;
      /**
       * The quantity of products being purchased.
       */
     ...
     * ]
     */
    export type PriceInputMappings = PriceInputMapping[];
    /**
     * Represents a price item
     * example:
     * {
     ...
     */
    export type PriceItems = (PriceItem | CompositePriceItem)[];
    /**
     * A valid set of product prices, quantities, (discounts) and taxes from a client.
     */
    export type PriceItemsDto = (PriceItemDto | CompositePriceItemDto)[];
    ...
    export interface PricingDetails {
      items?: (PriceItem | CompositePriceItem)[];
      /**
       * Total of all items before (discounts or) taxes are applied.
       */
    ...
    export interface ValidateAvailabilityFileResult {
       ...
       */
      errors: ValidateAvailabilityFileError[];
    }
  }
}
declare namespace Paths {
  ...
  namespace $ValidateAvailabilityFile {
    ...
    namespace Responses {
      export type $200 = Components.Schemas.ValidateAvailabilityFileResult;
      export type $400 = Components.Schemas.Error;
    }
  }
  namespace CreateOrder {
    export type RequestBody = Components.Schemas.OrderPayload;
    namespace Responses {
...
export interface OperationMethods {
  ...
  ): OperationResponse<Paths.CreateOrder.Responses.$201 | Paths.CreateOrder.Responses.$400>
  /**
   * putOrder - putOrder
   * 
  ...
  'putOrder'(
    ...
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.PutOrder.Responses.$200 | Paths.PutOrder.Responses.$400>
  /**
  ...
  '$availabilityCheck'(
    ...
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.$AvailabilityCheck.Responses.$200 | Paths.$AvailabilityCheck.Responses.$400>
  /**
  ...
  '$validateAvailabilityFile'(
    ...
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.$ValidateAvailabilityFile.Responses.$200 | Paths.$ValidateAvailabilityFile.Responses.$400>
  /**
