...
describe('computeCumulativeValue', () => {
  it.each`
    ...
    ${baseTiersUnitAmount} | ${5}                 | ${'kWh'}    | ${'en'}      | ${'EUR'} | ${undefined}   | ${undefined}  | ${undefined} | ${{ rate: 19 }} | ${{ total: '€50.00', totalWithPrecision: '€50.00', average: '€10.00/kWh', averageWithPrecision: '€10.00/kWh', subAverage: '€8.40/kWh', subAverageWithPrecision: '€8.403361344538/kWh', subtotal: '€42.02', subtotalWithPrecision: '€42.016806722689', breakdown: [{ quantityUsed: '5 kWh', tierAmountDecimal: '€10.00/kWh', totalAmountDecimal: '€50.00' }] }}
    ...
    ${baseTiersUnitAmount} | ${30}                | ${'kWh'}    | ${'en'}      | ${'USD'} | ${undefined}   | ${undefined}  | ${undefined} | ${{ rate: 19 }} | ${{ total: '$270.00', totalWithPrecision: '$270.00', average: '$9.00/kWh', averageWithPrecision: '$9.00/kWh', subAverage: '$7.56/kWh', subAverageWithPrecision: '$7.563025210084/kWh', subtotal: '$226.89', subtotalWithPrecision: '$226.890756302521', breakdown: [{ quantityUsed: '10 kWh', tierAmountDecimal: '$10.00/kWh', totalAmountDecimal: '$100.00' }, { quantityUsed: '10 kWh', tierAmountDecimal: '$9.00/kWh', totalAmountDecimal: '$90.00' }, { quantityUsed: '10 kWh', tierAmountDecimal: '$8.00/kWh', totalAmountDecimal: '$80.00' }] }}
    ${baseTiersUnitAmount} | ${0}                 | ${'kWh'}    | ${'en'}      | ${'USD'} | ${undefined}   | ${undefined}  | ${undefined} | ${{ rate: 19 }} | ${{ total: '$0.00', totalWithPrecision: '$0.00', average: '$0.00/kWh', averageWithPrecision: '$0.00/kWh', subAverage: '$0.00/kWh', subAverageWithPrecision: '$0.00/kWh', subtotal: '$0.00', subtotalWithPrecision: '$0.00', breakdown: [{ quantityUsed: '0 kWh', tierAmountDecimal: '$10.00/kWh', totalAmountDecimal: '$0.00' }] }}
    ${subunitTiers}        | ${5}                 | ${'kWh'}    | ${'en'}      | ${'USD'} | ${undefined}   | ${undefined}  | ${undefined} | ${{ rate: 19 }} | ${{ total: '5.00 cents', totalWithPrecision: '5.00 cents', average: '1.00 cent/kWh', averageWithPrecision: '1.00 cent/kWh', subAverage: '0.84 cents/kWh', subAverageWithPrecision: '0.840336 cents/kWh', subtotal: '4.20 cents', subtotalWithPrecision: '4.201681 cents', breakdown: [{ quantityUsed: '5 kWh', tierAmountDecimal: '1.00 cent/kWh', totalAmountDecimal: '5.00 cents' }] }}
    ${zeroTiers}           | ${1}                 | ${'kWh'}    | ${'en'}      | ${'USD'} | ${undefined}   | ${undefined}  | ${undefined} | ${{ rate: 19 }} | ${{ total: '$0.00', totalWithPrecision: '$0.00', average: '$0.00/kWh', averageWithPrecision: '$0.00/kWh', subAverage: '$0.00/kWh', subAverageWithPrecision: '$0.00/kWh', subtotal: '$0.00', subtotalWithPrecision: '$0.00', breakdown: [{ quantityUsed: '1 kWh', tierAmountDecimal: '$0.00/kWh', totalAmountDecimal: '$0.00' }] }}
    ${onRequestTiers}      | ${5}                 | ${'kWh'}    | ${'en'}      | ${'EUR'} | ${undefined}   | ${true}       | ${undefined} | ${{ rate: 19 }} | ${{ total: '€50.00', totalWithPrecision: '€50.00', average: '€10.00/kWh', averageWithPrecision: '€10.00/kWh', subAverage: '€8.40/kWh', subAverageWithPrecision: '€8.403361344538/kWh', subtotal: '€42.02', subtotalWithPrecision: '€42.016806722689', breakdown: [{ quantityUsed: '5 kWh', tierAmountDecimal: '€10.00/kWh', totalAmountDecimal: '€50.00' }] }}
    ${onRequestTiers}      | ${15}                | ${'kWh'}    | ${'en'}      | ${'EUR'} | ${undefined}   | ${true}       | ${undefined} | ${{ rate: 19 }} | ${'Price on request'}
    ${onRequestTiers}      | ${15}                | ${'kWh'}    | ${'en'}      | ${'EUR'} | ${undefined}   | ${false}      | ${undefined} | ${{ rate: 19 }} | ${{ total: '€145.00', totalWithPrecision: '€145.00', average: '€9.67/kWh', averageWithPrecision: '€9.666666666667/kWh', subAverage: '€8.12/kWh', subAverageWithPrecision: '€8.12324929972/kWh', subtotal: '€121.85', subtotalWithPrecision: '€121.848739495798', breakdown: [{ quantityUsed: '10 kWh', tierAmountDecimal: '€10.00/kWh', totalAmountDecimal: '€100.00' }, { quantityUsed: '5 kWh', tierAmountDecimal: '€9.00/kWh', totalAmountDecimal: '€45.00' }] }}
