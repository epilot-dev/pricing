...
export const processNetworkOperatingFeesTable = (
  ...
  result.groups['network_operating_fees'] = {
    ...
    fees: {
      network_operating_fee_base: getTableFee(
        externalFeesMetadata.breakdown.static?.['basic_fee'],
        i18n.t(`table_order.getag_details_table.groups.network_operating_fees.fees.network_operating_fee_base`),
        currency,
        i18n,
        billingPeriod,
        unitPricePeriod,
      ...
      type === 'power'
        ? {
            network_operating_fee_work: getTableFee(
              externalFeesMetadata.breakdown.variable?.['power_kwh_ht'],
              i18n.t(`table_order.getag_details_table.groups.network_operating_fees.fees.network_operating_fee_work`) +
                ' (HT)',
              currency,
              i18n,
              billingPeriod,
            ...
            network_operating_fee_work_nt: getTableFee(
              externalFeesMetadata.breakdown.variable?.['power_kwh_nt'],
              i18n.t(`table_order.getag_details_table.groups.network_operating_fees.fees.network_operating_fee_work`) +
                ' (NT)',
              currency,
        ...
        : type === 'power'
          ...
          : {
              network_operating_fee_work: getTableFee(
                externalFeesMetadata.breakdown.variable?.['grid_fee'],
                i18n.t(`table_order.getag_details_table.groups.network_operating_fees.fees.network_operating_fee_work`),
                currency,
                i18n,
                billingPeriod,
