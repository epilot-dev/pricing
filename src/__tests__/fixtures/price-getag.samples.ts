...
export const priceTieredVolumeGetAG: PriceItemDto = {
  quantity: 1,
  product_id: 'prod-id#1',
  price_id: 'price#1',
  _price: {
...
export const compositePriceTieredVolumeGetAG: PriceItemDto = {
  description: 'Test GetAG Composite',
  is_composite_price: true,
  _tags: ['composite'],
  _schema: 'price',
...
export const compositePriceTieredFlatFeeGetAG: PriceItemDto = {
  description: 'Test GetAG Composite',
  is_composite_price: true,
  _tags: ['composite'],
  _schema: 'price',
