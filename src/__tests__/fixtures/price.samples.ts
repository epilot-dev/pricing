...
const customPriceItem: PriceItemDto = {
...
export const priceItemRateless: PriceItemDto = {
  quantity: 1,
  product_id: 'prod-id#12324',
  price_id: 'price#3',
  _price: {
...
export const compositePriceWithRateless: CompositePriceItemDto = {
  price_id: 'price#66',
  product_id: 'prod-id#1234',
  quantity: 1,
  description: 'Eletricity Pack 1',
  _price: {
    ...
    price_components: [
      ...
      },
      {
        ...
        renewal_duration_unit: 'months',
        _schema: 'price',
        _title: 'Energy price per kWh, rateless',
        description: 'Energy price per kWh, rateless',
        unit: 'kwh',
        tax: [taxRateless],
        is_tax_inclusive: true,
        _org: '739224',
...
export const compositePriceWithMappingForNotVariableComponent: CompositePriceItemDto = {
  is_tax_inclusive: true,
  active: true,
  price_display_in_journeys: 'show_price',
  type: 'one_time',
...
export const compositePriceWithComponentsWithCoupons: CompositePriceItemDto = {
  price_id: 'price#4',
  product_id: 'prod-id#1234',
  quantity: 1,
  description: 'Eletricity Pack 1',
...
export const compositePriceWithComponentsWithCashbackCoupons: CompositePriceItemDto = {
